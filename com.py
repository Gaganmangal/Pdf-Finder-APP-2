...
#----------------------------------------Ram Issue Code For Duplicate Detection more then 4 lakh files----------------------------------------
import os
import hashlib
import pymongo
from datetime import datetime, timezone
...
# def run_file_access_pattern(db, scan_start_time):
#     print("📊 Building FileMetaAccess (incremental + safe)...")

#     now = datetime.now(timezone.utc)

#     pipeline = [
#         # ONLY files from this scan
#         {
#             "$match": {
#                 "updatedAt": { "$gte": scan_start_time }
#             }
#         },
#         {
#             "$project": {
...
#             "$addFields": {
#                 "effectiveUserAccessAt": {
#                     "$ifNull": ["$osAccessedAt", "$firstSeenAt"]
#                 }
#             }
#         },
#         {
...
#                 "accessClass": {
#                     "$cond": [
#                         {"$lte": ["$daysSinceUserAccess", 7]},
#                         "HOT",
#                         {
#                             "$cond": [
#                                 {"$lte": ["$daysSinceUserAccess", 30]},
#                                 "WARM",
#                                 "COLD"
#                             ]
#                         }
...
#         }
#     ]
#     db.FileMetaLatest.aggregate(pipeline,allowDiskUse=True,batchSize=2000)
#     print("✅ FileMetaAccess updated incrementally")
...
#----------------------------------------Updated Code For Duplicate Detection----------------------------------------
# import os
# import hashlib
# import pymongo
# from datetime import datetime, timezone
...
# def build_duplicate_fingerprints(db):
#     print("🔍 Step 1: Finding duplicate fingerprints...")
...
#     db.FileMetaLatest.aggregate(pipeline, allowDiskUse=True)
#     print("✅ Duplicate fingerprints stored")


# def build_duplicate_files(db):
#     print("📂 Step 2: Expanding duplicate files...")

#     pipeline = [
#         {
#             "$lookup": {
#                 "from": "DuplicateFingerprints",
...
#     db.FileMetaLatest.aggregate(pipeline, allowDiskUse=True)
#     print("✅ Duplicate files expanded")
